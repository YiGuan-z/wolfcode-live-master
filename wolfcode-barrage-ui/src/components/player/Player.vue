<template>
    <div style="margin: 0 auto;  width: 1250px;">
        ...
        <div>
            <login :visible="loginVisible" @closelogin="handleLoginVisible"/>
            <div style="float: left">
                <div ref="videoOuterLayer" class="uncheck" @mouseleave="Leave()" @mousemove="MouseMove()">
                    <div id="video" ref="videoBox" @click="CloseMenuOrPlayVideo($event)"
                    ...
                    <!--发送弹幕组件-->
                    <sendBarrage @loginvisible="handleLoginVisible"></sendBarrage>
            ...
            <div class="about">
                ...
                <div style="overflow: auto; height: 480px;">
                    <div v-for="(item, index) of barrageHistoryList" :key="index" class="barrage-content"
                         v-on:click="changBackGroundColor()" v-bind:style="barrageContentStyle">
