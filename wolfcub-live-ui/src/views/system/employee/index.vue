      ...
      <el-row>
        ...
        <el-col :span="4">
          <div style="padding-right: 20px">
            ...
            <el-tree :default-expand-all="true" :filter-node-method="filterNode" ref="tree" :expand-on-click-node="false" node-key="id" :data="treeList"
          ...
          <el-row>
            <el-form :inline="true" size="mini" :model="searchForm" class="demo-form-inline">
              <el-form-item label="关键字">
                <el-input v-model="searchForm.keyword" placeholder="请输入用户名/姓名"></el-input>
              </el-form-item>
              <el-form-item>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogFormVisible" width="40%">
      <el-form :model="editForm" :rules="rules" status-icon ref="editForm" label-width="80px" class="demo-ruleForm">
        ...
        <el-form-item label="姓名" prop="name">
          <el-input type="name" v-model="editForm.name" autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="入职时间" prop="hireDate">
          <el-date-picker type="date" value-format="yyyy-MM-dd" placeholder="选择日期" v-model="editForm.hireDate"/>
        </el-form-item>
      </el-form>
