...
public class ReportServiceImpl implements IReportService {
	...
	@Override
	public Report selectInfoByPrimaryKey(Long id) {
		final var ret = mapper.selectInfoByPrimaryKey(id);
		if (Objects.isNull(ret)) throw new RuntimeException("数据未找到");
		//状态1是正在审核
		ret.setStatus(1);
		mapper.updateByPrimaryKey(ret);
		return ret;
	}
}
